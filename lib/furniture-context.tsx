...
export type FurnitureTab = "chair" | "table" | "roundTable" | "bancoMehinaku" | "bancoMehinakuPerfurado" | "bancoWauja" | "bancoTecido" | "malhaPlanificada";
...
const defaultParams: FurnitureParams = {
  ...
  bancoMehinakuColumnRadius: 0.004, // Raio das colunas (parafusos de rosca) - aumentado para maior robustez
